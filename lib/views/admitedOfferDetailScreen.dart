...
class AdmitedDetailScreen extends StatefulWidget {
  ...
  @override
  State<AdmitedDetailScreen> createState() => _AdmitedDetailScreenState();
}
    ...
    return GetBuilder<HomeController>(builder: (homeController1) {
      return SafeArea(
        child: Scaffold(
              ...
              child: CustomScrollView(
                slivers: [
                  global.getPlatFrom()
                    ...
                    child: Stack(
                      ...
                      children: [
                        Container(
                          ...
                          child: CustomImage(
                            image: '${global.appInfo.baseUrls.offerImageUrl}/${widget.admitedData['image']}',
                            width: 500,
                            height: 300,
                            fit: BoxFit.fill,
                          ),
                        ...
                        Positioned(
                          ...
                          child: Card(
                            ...
                            child: Padding(
                              ...
                              child: CustomImage(
                                image: '${global.appInfo.baseUrls.partnerImageUrl}/${widget.admitedData['partner']['image']}',
                                height: 30,
                                width: 60,
                                fit: BoxFit.contain,
                              ),
                    ...
                    title: Text(
                      widget.admitedData['partner']['name'],
                      ...
                      !GetPlatform.isWeb
                        ...
                        onTap: () async {
                          if (global.currentUser.id != null) {
                            ...
                            _admitedOffers.admitedGetLink(
                                widget.admitedData['gotourl'].toString(),
                                "admitad",
                                widget.admitedData['ad_id'].toString()
                            ).then((value) {
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              HtmlWidget(
                                widget.admitedData['description'],
                                //textAlign: TextAlign.center,
                              ),
                              // Text(
                              //   offer.terms,
                              ...
                              InkWell(
                                onTap: () async {
                                  if (global.currentUser.id != null) {
                                    ...
                                    //   global.appInfo.baseUrls.offerImageUrl + '/' + widget.campaign.image,
                                    //   homeController.createdLink.isNotEmpty ? homeController.createdLink : widget.campaign.url,
                                    // );
                                  ...
                                  global.getPlatFrom()
                                    ...
                                    Dialog(
                                      child: SizedBox(
                                        height: 500,
                                        width: 500,
                                        child: MoreAdmitedOffers(id: widget.admitedData['id'].toString(),),
                                      ),
                                    ),
                                  )
                                      : Get.bottomSheet(
          ...
          bottomNavigationBar: widget.admitedData['partner'] != null && (widget.admitedData['partner']['left_tab'] !=null || widget.admitedData['partner']['right_tab']!=null)
              ? Container(
            width: Get.width,
            alignment: Alignment.center,
            height: 50,
            child: SizedBox(
              ...
              child: Card(
                ...
                child: Row(
                  mainAxisAlignment: (widget.admitedData['partner']['left_tab']!=null && widget.admitedData['partner']['right_tab']!=null) ? MainAxisAlignment.spaceEvenly : MainAxisAlignment.center,
                  children: [
                    InkWell(
                      onTap: () {
                          ...
                          SizedBox(
                            ...
                            child: ClipRRect(
                              ...
                              child: RatesAndOfferTermsSheetWidget(
                                partner: widget.admitedData['partner'],
                              ),
                            ),
                          ),
                        );
                      ...
                      child: Text(
                        widget.admitedData['partner']['left_tab'],
                        style: Get.theme.primaryTextTheme.titleSmall.copyWith(fontWeight: FontWeight.w400, color: Colors.white),
                      ),
                    ),
                    (widget.admitedData['partner']['left_tab']!=null && widget.admitedData['partner']['right_tab']!=null)
                        ? Icon(
                      Icons.more_vert,
                      size: 22,
                    ...
                    InkWell(
                      ...
                      child: Text(
                        widget.admitedData['partner']['right_tab'].camelCase,
                        style: Get.theme.primaryTextTheme.titleSmall.copyWith(fontWeight: FontWeight.w400, color: Colors.white),
                      ),
                    ),
                  ],
