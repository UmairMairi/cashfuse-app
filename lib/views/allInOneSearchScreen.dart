...
class _AppTabinationScreenState extends State<AllInOneSearchScreen> with TickerProviderStateMixin {
  ...
  tabCreate() {
    return Scaffold(
        ...
        appBar: _isDataLoaded
            ? PreferredSize(
                preferredSize: Size(AppConstants.WEB_MAX_WIDTH / 2, kToolbarHeight),
                child: Center(
                  child: TabBar(
                    isScrollable: true,
                                ...
                                : WebView(
                                    ...
                                    onWebViewCreated: (controller) {
                                      ...
                                      webViewController.loadUrl(
                                        searchController.addNewTabList2[index].trackingUrl,
                                      );
