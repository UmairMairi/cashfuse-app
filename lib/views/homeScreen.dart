                    ...
                    return GetBuilder<CouponController>(builder: (cont) {
                      return RefreshIndicator(
                        ...
                        child: Consumer<ProductListProvider>(
                          builder: (context,productList,Widget child) {
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          productList.productListData.isEmpty?
                                              SizedBox(
                                            height: 155,
                                            child: ListView.builder(
                                                scrollDirection: Axis.horizontal,
                            ...
                            SizedBox(
                                    ...
                                    child: ListView.builder(
                                      scrollDirection: Axis.horizontal,
                                      itemCount: productList.productListData['data'].length,
                                      shrinkWrap: true,
                                     // padding: const EdgeInsets.symmetric(horizontal: 6),
                                      itemBuilder: (context, index) {
                                        return InkWell(
                                          onTap: () {
                                            ...
                                            Navigator.push(context, MaterialPageRoute(builder:(context)=>ProductDetails(
                                              title:productList.productListData['data'][index]['name'] ,
                                              productData:productList.productListData['data'][index] ,
                                            )));
                                          },
                                          child: Container(
                                            width:150,
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: RichText(
                                                    text: TextSpan(
                                                      ...
                                                      children: [
                                                        TextSpan(text: '${productList.productListData['data'][index]['product_prices'].length}', style: TextStyle(fontWeight: FontWeight.w500,
                                                            fontSize: 10,
                                               ...
                                               //   color: Colors.blueAccent,
                                                  child: Stack(
                                                    children: [
                                                      Image.network(
                                                        "${global.appInfo.baseUrls.productImageurl}/${productList.productListData['data'][index]['image']}",
                                                ...
                                                Padding(
                                                  ...
                                                  child: RichText(
                                                    text: TextSpan(
                                                        ...
                                                        children: [
                                                          TextSpan(text:'${productList.productListData['data'][index]['name']} ', style: TextStyle(fontWeight: FontWeight.w600,
                                                              fontSize: 10,
                                                              color: Colors.black
                                                          )),
                                                        ]
                                                ...
                                                Padding(
                                                  padding: const EdgeInsets.only(
                                                      ...
                                                      bottom: 8),
                                                  child: Text(
                                                         "${productList.productListData['data'][index]['name']} ",
                                                        style: TextStyle(
                                                            color: Colors.black54,
                                                            fontWeight: FontWeight.w500,
                                                            fontSize: 10
                                                ...
                                                Container(
                                                  ...
                                                  child:
                                                  Text("+${productList.productListData['data'][index]['cashback']}  CASHBACK",
                                                  style: TextStyle(
                                                    fontSize: 11,
                                                    fontWeight: FontWeight.w600,
                                                    color: Mycolors.orange
                                                ...
                                                Padding(
                                                  padding: const EdgeInsets.only(
                                                      ...
                                                      bottom: 8),
                                                  child: Text(
                                                    "Final Price ${productList.productListData['data'][index]['product_prices'][0]['price']}",
                                                    style: TextStyle(
                                                        color: Mycolors.blue,
                                                        fontWeight: FontWeight.w500,
                                                        fontSize: 12
