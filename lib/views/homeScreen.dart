                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Stack(
                                                              ...
                                                              children: [
                                                                ...
                                                                homeController.exclusiveOfferList[index].dayDifference !=
                                                                            null &&
                                                                        homeController.exclusiveOfferList[index].dayDifference! >
                                                                            0
                                                                    ? Padding(
                                                                  ...
                                                                  .builder(
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return InkWell(
                                                                          onTap:
                                                                              () async {
                                                                            if (homeController.homeAdvList[index].commonList[i].adId != null &&
                                                                              ...
                                                                              await homeController.getAdmitedDetails(homeController.homeAdvList[index].commonList[i].campaignId!);
                                                                          ...
                                                                          child:
                                                                              OfferWidget(
                                                                            commonModel:
                                                                                homeController.homeAdvList[index].commonList[i],
                                                                            domainImage:
                                                                                homeController.homeAdvList[index].image!,
                                                                            fromList:
                                                                                false,
                                                                          ),
                                                                        );
