...
//
//     final admitedOffersModal = admitedOffersModalFromJson(jsonString);

import 'dart:convert';

List<AdmitedOffersModal> admitedOffersModalFromJson(String str) => List<AdmitedOffersModal>.from(json.decode(str).map((x) => AdmitedOffersModal.fromJson(x)));

String admitedOffersModalToJson(List<AdmitedOffersModal> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class AdmitedOffersModal {
  ...
  factory AdmitedOffersModal.fromJson(Map<String, dynamic> json) => AdmitedOffersModal(
    id: json["id"],
    adId: json["ad_id"],
    advId: json["adv_id"],
    name: json["name"],
