...
class CodePickerWidgetState extends State<CodePickerWidget> {
            ...
            if (widget.showFlagMain != null ? widget.showFlagMain : widget.showFlag)
              Flexible(
                ...
                child: Container(
                  ...
                  margin: widget.alignLeft ? const EdgeInsets.only(right: 8.0, left: 8.0) : const EdgeInsets.only(right: 8.0, left: 8.0),
                  child: Image.asset(
  ...
  void didUpdateWidget(CodePickerWidget oldWidget) {
    ...
    if (oldWidget.initialSelection != widget.initialSelection) {
      if (widget.initialSelection != null) {
        selectedItem = elements.firstWhere((e) => (e.code.toUpperCase() == widget.initialSelection.toUpperCase()) || (e.dialCode == widget.initialSelection) || (e.name.toUpperCase() == widget.initialSelection.toUpperCase()), orElse: () => elements[0]);
      } else {
  ...
  void initState() {
    ...
    favoriteElements = elements.where((e) => widget.favorite.firstWhereOrNull((f) => e.code.toUpperCase() == f.toUpperCase() || e.dialCode == f || e.name.toUpperCase() == f.toUpperCase()) != null).toList();
  }
